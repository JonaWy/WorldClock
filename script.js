...
(function() {
  ...
  const timezones = [
    // Americas
    { timezone: 'America/New_York', city: 'New York', country: 'USA', region: 'EST' },
    { timezone: 'America/Los_Angeles', city: 'Los Angeles', country: 'USA', region: 'PST' },
    { timezone: 'America/Chicago', city: 'Chicago', country: 'USA', region: 'CST' },
    { timezone: 'America/Denver', city: 'Denver', country: 'USA', region: 'MST' },
    { timezone: 'America/Toronto', city: 'Toronto', country: 'Canada', region: 'EST' },
    { timezone: 'America/Vancouver', city: 'Vancouver', country: 'Canada', region: 'PST' },
    { timezone: 'America/Mexico_City', city: 'Mexico City', country: 'Mexico', region: 'CST' },
    { timezone: 'America/Sao_Paulo', city: 'São Paulo', country: 'Brazil', region: 'BRT' },
    { timezone: 'America/Buenos_Aires', city: 'Buenos Aires', country: 'Argentina', region: 'ART' },
    
    // Europe
    { timezone: 'Europe/London', city: 'London', country: 'UK', region: 'GMT' },
    { timezone: 'Europe/Paris', city: 'Paris', country: 'France', region: 'CET' },
    { timezone: 'Europe/Berlin', city: 'Berlin', country: 'Germany', region: 'CET' },
    { timezone: 'Europe/Madrid', city: 'Madrid', country: 'Spain', region: 'CET' },
    { timezone: 'Europe/Rome', city: 'Rome', country: 'Italy', region: 'CET' },
    { timezone: 'Europe/Amsterdam', city: 'Amsterdam', country: 'Netherlands', region: 'CET' },
    { timezone: 'Europe/Moscow', city: 'Moscow', country: 'Russia', region: 'MSK' },
    { timezone: 'Europe/Istanbul', city: 'Istanbul', country: 'Turkey', region: 'TRT' },
    
    // Asia
    { timezone: 'Asia/Dubai', city: 'Dubai', country: 'UAE', region: 'GST' },
    { timezone: 'Asia/Kolkata', city: 'Mumbai', country: 'India', region: 'IST' },
    { timezone: 'Asia/Singapore', city: 'Singapore', country: 'Singapore', region: 'SGT' },
    { timezone: 'Asia/Hong_Kong', city: 'Hong Kong', country: 'China', region: 'HKT' },
    { timezone: 'Asia/Shanghai', city: 'Shanghai', country: 'China', region: 'CST' },
    { timezone: 'Asia/Tokyo', city: 'Tokyo', country: 'Japan', region: 'JST' },
    { timezone: 'Asia/Seoul', city: 'Seoul', country: 'South Korea', region: 'KST' },
    { timezone: 'Asia/Bangkok', city: 'Bangkok', country: 'Thailand', region: 'ICT' },
    { timezone: 'Asia/Jakarta', city: 'Jakarta', country: 'Indonesia', region: 'WIB' },
    
    // Oceania
    { timezone: 'Australia/Sydney', city: 'Sydney', country: 'Australia', region: 'AEDT' },
    { timezone: 'Australia/Melbourne', city: 'Melbourne', country: 'Australia', region: 'AEDT' },
    { timezone: 'Australia/Perth', city: 'Perth', country: 'Australia', region: 'AWST' },
    { timezone: 'Pacific/Auckland', city: 'Auckland', country: 'New Zealand', region: 'NZDT' },
    
    // Africa
    { timezone: 'Africa/Cairo', city: 'Cairo', country: 'Egypt', region: 'EET' },
    { timezone: 'Africa/Johannesburg', city: 'Johannesburg', country: 'South Africa', region: 'SAST' },
    { timezone: 'Africa/Lagos', city: 'Lagos', country: 'Nigeria', region: 'WAT' },
  ];
  ...
  function calculateTimeDifference(targetTz, homeTz) {
    ...
    const targetHours = parseInt(new Intl.DateTimeFormat('en-US', {
      timeZone: targetTz,
      hour: 'numeric',
      hour12: false
    }).format(now));
    
    const homeHours = parseInt(new Intl.DateTimeFormat('en-US', {
      timeZone: homeTz,
      hour: 'numeric',
      hour12: false
    }).format(now));
  ...
  function renderAllClocks() {
    ...
    const filteredTimezones = timezones.filter(tz => tz.timezone !== homeTimezone);
  ...
  function init() {
    ...
    // Create home clock
    const homeConfig = findTimezoneConfig(homeTimezone) || getTimezoneInfo(homeTimezone);
